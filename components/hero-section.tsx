  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 pt-32">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        <h1 className="font-dream-avenue text-7xl md:text-9xl mb-6 text-balance text-primary">Aprende Cine</h1>
        <p className="text-xl md:text-2xl font-medium mb-4 text-balance text-white">
